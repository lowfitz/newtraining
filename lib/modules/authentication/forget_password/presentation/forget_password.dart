...
import 'package:new_bussiness_app/modules/authentication/otp/presentation/otp_confirmation.dart';
        ...
        builder: (context, state) {
          return Form(
            ...
            child: Scaffold(
              ...
              const Center(
                child: Text(
                    'الرجاء كتابة رقم الجوال المسجل لدينا لاستعادة كلمة المرور',
                    style: TextStyle(
                      fontSize: 11,
                    )),
              ),
